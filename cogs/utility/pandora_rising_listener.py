...
class Utility(commands.Cog):
    ...
    async def on_member_join(self, member):
        if member.guild.id == 748700165266866227:
            ...
            with open('cogs/utility/files/pandora_rising/server_info.json', 'r', encoding='utf-8') as fh:
            ...
            with open('cogs/utility/files/pandora_rising/server_info.json', 'w', encoding='utf-8') as fh:
