...
async def adminMsgs(ctx, bot, guild):
    ...
    if user.top_role.name == "Olo'eyktan (Admin)":
        ...
        changeLog = "10/5/2020 - Updated the channel formatting and added new channels.\n10/15/2020 - Fixed the description for {} and updated the Role Descriptions.\n11/1/2020 - Ran to update emojis on the channel names.".format(guild.get_channel(757026975696027688).mention)
